...
# with command line options: GeneratorInterface/ReggeGribovPartonMCInterface/ReggeGribovPartonMC_EposLHC_2760GeV_PbPb_cfi -s GEN --conditions auto:mc --datatier GEN --eventcontent RAWSIM -n 1 --scenario HeavyIons --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ReggeGribovPartonMC_EposLHC_5020GeV_PbPb_cfi_GEN.root'),
